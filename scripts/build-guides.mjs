...
export const GUIDES = [
  ...
  },
  {
    ...
    useCase: [
      "Google AI is the broad Gemini subscription layer, and the Plus, Pro, and Ultra tiers are the current paid plans that surface the Gemini Omni Flash / Daily Brief / Nano Banana bundle on Plus and the Jules / Google Antigravity / Google Home Premium / YouTube Premium Lite bundle on Pro alongside the current Gemini 3 Pro / 3.6 Flash wording. This guide compares those higher Google AI plans against a local AI box and shows where the recurring subscription cost catches up.",
